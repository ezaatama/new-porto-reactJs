            ...
            <div className={style.navbar}>
                <div className={style.navbarContainer}>
                    ...
                    <ul className={ click ? style.navMenuActive : style.navMenu }>
                        ...
                        <li className={style.navItem}>
                            <Link to='/about' className={style.navLinks} onClick={closeMobileMenu}>
                                About
                            </Link>
                        </li>
                        <li className={style.navItem}>
                            <Link to='/portofolio' className={style.navLinks} onClick={closeMobileMenu}>
                                Portofolio
                            </Link>
                        </li>
                        <li className={style.navItem}>
                            <Link to='/contact' className={style.navLinks} onClick={closeMobileMenu}>
                                Contact
                            </Link>
                        </li>
                    </ul>
