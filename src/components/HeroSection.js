...
function HeroSection({
    ...
    return (
        ...
        <div className={style.particle}>
            ...
            <div className={lightBg ? style.homeHeroSection : style.homeHeroSectionDarkBg}>
                <div className={style.container}>
                    <div className={style.homeHeroRow} style={{ display: 'flex', flexDirection: imgStart === 'start' ? 'row-reverse' : 'row'}}>
                        <div className={style.col}>
                            <div className={style.homeHeroTextWrapper}>
                                <h1 className={lightText ? style.heading : style.headingDark}>
                                    {headline}
                                </h1>
                                <p className={lightTextDesc ? style.subtitle : style.subtitleDark}>
                                    {description}
                                </p>
                            </div>
                            <div className={style.homeHeroButton}>
                                <Link to='/'>
                                    <button className={style.btnWide} >
                                        {buttonLabel1}
                                    </button>
                                </Link>
                                <Link to='/contact'>
